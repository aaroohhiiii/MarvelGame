// src/data/riddles.js
// Timeline dynamically shuffles on every page refresh!

// Base riddles data in chronological order
const baseRiddles = [
  {
    id: 1,
...
// Export shuffled riddles - NEW ORDER EVERY PAGE REFRESH!
export const riddles = shuffleArray(baseRiddles);
